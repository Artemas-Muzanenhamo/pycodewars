import unittest
from solutions.kyu8 import list_contains


class ListContainsTest(unittest.TestCase):
    def test_if_list_contains_value(self):
        tests = [
            (True, ([66, 101], 66)),
        ...
        for exp, inp in tests:
            self.assertEqual(list_contains.check(*inp), exp)
